...
import csv
import os
folder = os.listdir('/Users/RoyKudo/Desktop/FST results/diameter_only/')

# use bodycenter
for f in folder:
    if '.csv' in f:
        with open('/Users/RoyKudo/Desktop/FST results/diameter_only/' + f) as fh:
        ...
        #for x axis:
        l = []
        with open('/Users/RoyKudo/Desktop/FST results/coor csv/' + f.replace('.csv', '_coor.csv'), "r") as csv_file:
        ...
        with open('/Users/RoyKudo/Desktop/FST results/FST_total_distance_result.csv', 'a') as t:
